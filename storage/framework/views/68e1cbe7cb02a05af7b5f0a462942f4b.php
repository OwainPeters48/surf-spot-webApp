...
<?php $component->withAttributes([]); ?>
    <section class="p-6 bg-white border-b border-gray-200">
        <header class="mb-4">
            <h2 class="text-xl font-semibold">Welcome, <?php echo e(Auth::user()->name); ?>!</h2>
        ...
        <section>
            ...
            <?php if($userComments->isEmpty()): ?>
                <p>You have not commented on any surf spots yet.</p>
            <?php else: ?>
                <?php $__currentLoopData = $userComments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article class="my-2 border-b border-gray-300 pb-2">
                        <p>
                            <strong><?php echo e($comment->surfSpot->name); ?></strong>: 
                            <q><?php echo e($comment->content); ?></q>
                        </p>
                    </article>
        ...
        <?php if($likedSurfSpots->isNotEmpty()): ?>
            <section>
                <h3 class="mt-6 text-lg font-semibold">Surf Spots You Liked</h3>
                <ul>
                    <?php $__currentLoopData = $likedSurfSpots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $surfSpot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="mt-4 border-b border-gray-300 pb-4">
                            <h4 class="font-semibold"><?php echo e($surfSpot->name); ?></h4>
                            <p>Location: <?php echo e($surfSpot->location); ?></p>
                            <p>Description: <?php echo e($surfSpot->description); ?></p>
                            <p>Difficulty: <?php echo e(ucfirst($surfSpot->difficulty)); ?></p>
                            <p>Total Likes: <?php echo e($surfSpot->users()->count()); ?></p>

                            <?php
                                $userComment = $surfSpot->comments->where('user_id', Auth::id())->first();
                            ?>
                            <?php if($userComment): ?>
                                <p>Your Comment: <q><?php echo e($userComment->content); ?></q></p>
                            <?php else: ?>
        ...
        <div id="error-message" class="text-red-600 font-bold mb-4" aria-live="assertive"></div>
                ...
                <section aria-labelledby="surf-spots-title">
                    ...
                    <div id="surf-spot-list">
                        <?php $__currentLoopData = $allSurfSpots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $surfSpot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <article class="border p-4 mb-4 rounded" aria-labelledby="surf-spot-<?php echo e($surfSpot->id); ?>-title">
                                <!-- Surf Spot Details -->
                                <header>
                                    <h4 id="surf-spot-<?php echo e($surfSpot->id); ?>-title" class="text-xl font-semibold"><?php echo e($surfSpot->name); ?></h4>
                                </header>
                                <p>Location: <?php echo e($surfSpot->location); ?></p>
                                <p>Description: <?php echo e($surfSpot->description); ?></p>
                                <p>Difficulty: <?php echo e(ucfirst($surfSpot->difficulty)); ?></p>
                                <p>Total Views: <?php echo e($surfSpot->view_count); ?></p>
                                <p>Likes: <?php echo e($surfSpot->users()->count()); ?></p>
                                ...
                                <?php if(Auth::user()->role === 'admin'): ?>
                                    ...
                                    <button 
                                        ...
                                        onclick="toggleEditForm(<?php echo e($surfSpot->id); ?>)"
                                        aria-label="Edit details for surf spot <?php echo e($surfSpot->name); ?>"
                                    >
                                        Edit Surf Spot
                                    </button>

                                    <!-- Edit Form -->
                                    <div id="edit-form-<?php echo e($surfSpot->id); ?>" class="hidden mt-4">
                                        <form id="edit-surfspot-form-<?php echo e($surfSpot->id); ?>" aria-label="Edit form for <?php echo e($surfSpot->name); ?>">
                                            <?php echo csrf_field(); ?>
                                            <div class="grid gap-2">
                                                <label for="name-<?php echo e($surfSpot->id); ?>">Name</label>
                                                <input 
                                                    type="text" 
                                                    id="name-<?php echo e($surfSpot->id); ?>"
                                                    name="name" 
                                                    value="<?php echo e($surfSpot->name); ?>" 
                                                    class="border p-2 rounded w-full"
                                                    required
                                                />

                                                <label for="location-<?php echo e($surfSpot->id); ?>">Location</label>
                                                <input 
                                                    type="text" 
                                                    id="location-<?php echo e($surfSpot->id); ?>"
                                                    name="location" 
                                                    value="<?php echo e($surfSpot->location); ?>" 
                                                    class="border p-2 rounded w-full"
                                                    required
                                                />

                                                <label for="description-<?php echo e($surfSpot->id); ?>">Description</label>
                                                <textarea 
                                                    id="description-<?php echo e($surfSpot->id); ?>"
                                                    name="description" 
                                                    class="border p-2 rounded w-full"
                                                    required
                                                ><?php echo e($surfSpot->description); ?></textarea>

                                                <label for="difficulty-<?php echo e($surfSpot->id); ?>">Difficulty</label>
                                                <select 
                                                    id="difficulty-<?php echo e($surfSpot->id); ?>"
                                                    name="difficulty" 
                                                    class="border p-2 rounded w-full"
                                                    required
                                                >
                                                    <option value="beginner" <?php echo e($surfSpot->difficulty === 'beginner' ? 'selected' : ''); ?>>Beginner</option>
                                                    <option value="intermediate" <?php echo e($surfSpot->difficulty === 'intermediate' ? 'selected' : ''); ?>>Intermediate</option>
                                                    <option value="advanced" <?php echo e($surfSpot->difficulty === 'advanced' ? 'selected' : ''); ?>>Advanced</option>
                                                </select>

                                                <button 
                                                    type="button" 
                                                    class="bg-green-500 text-white px-4 py-2 rounded mt-2 focus:outline-none focus:ring focus:ring-green-300"
                                                    onclick="editSurfSpot(event, <?php echo e($surfSpot->id); ?>)"
                                                    aria-label="Update details for surf spot <?php echo e($surfSpot->name); ?>"
                                                >
                                                    Update Surf Spot
                                                </button>
                                            </div>
                                ...
                                <!-- Comment Form -->
                                <form id="comment-form-<?php echo e($surfSpot->id); ?>" class="mt-4" aria-label="Comment form for <?php echo e($surfSpot->name); ?>">
                                    <?php echo csrf_field(); ?>
                                    <label for="comment-content-<?php echo e($surfSpot->id); ?>">Write a comment</label>
                                    <textarea
                                        id="comment-content-<?php echo e($surfSpot->id); ?>"
                                        name="content"
                                    ...
                                    <button
                                        type="submit"
                                        class="bg-blue-500 text-white px-4 py-2 rounded mt-2 focus:outline-none focus:ring focus:ring-blue-300"
                                        onclick="postComment(event, <?php echo e($surfSpot->id); ?>)"
                                        aria-label="Post comment on surf spot <?php echo e($surfSpot->name); ?>"
                                    >
                                        Post Comment
                                    </button>
                                </form>
                                ...
                                <!-- Comment List -->
                                <div id="comments-list-<?php echo e($surfSpot->id); ?>" class="mt-4" aria-label="Comments for <?php echo e($surfSpot->name); ?>">
                                    <?php $__currentLoopData = $surfSpot->comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="comment border p-3 rounded mb-3 flex justify-between items-center" id="comment-<?php echo e($comment->id); ?>">
                                        <p>
                                            <strong class="text-gray-800"><?php echo e($comment->user->name); ?></strong>: 
                                            <span class="comment-content text-gray-600"><?php echo e($comment->content); ?></span>
                                        </p>
                                        <div class="flex gap-2">
                                            <?php if(Auth::user() && Auth::user()->role === 'admin'): ?>
                                                ...
                                                <button
                                                    ...
                                                    onclick="editComment(<?php echo e($comment->id); ?>, '<?php echo e($comment->content); ?>')"
                                                >
                                                    Edit
                                                </button>
                                ...
                                <!-- Favourite Button -->
                                <button 
                                    onclick="toggleFavourite(<?php echo e($surfSpot->id); ?>)"
                                    class="bg-yellow-500 text-white px-4 py-2 rounded mt-2 focus:outline-none focus:ring focus:ring-yellow-300"
                                    aria-label="<?php echo e(Auth::user()->favouriteSurfSpots->contains($surfSpot->id) ? 'Remove from favourites' : 'Add to favourites'); ?> surf spot <?php echo e($surfSpot->name); ?>"
                                >
                                    <?php if(Auth::user()->favouriteSurfSpots->contains($surfSpot->id)): ?>
                                        Unfavourite
                                    <?php else: ?>
                                        Favourite
                                    <?php endif; ?>
                    ...
                    <nav class="mt-4" aria-label="Surf spots pagination">
                        <?php echo e($allSurfSpots->appends(['user_page' => $userPage])->links()); ?>
                    ...
                    <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="border-b border-gray-200 py-2 flex justify-between items-center" role="listitem">
                            ...
                            <button 
                                ...
                                aria-label="Mark notification as read: <?php echo e($notification->data['message']); ?>"
                            >
                                Mark as Read
                            </button>
                        </li>
        ...
        <?php if(Auth::user()->role === 'admin'): ?>
                        ...
                        <tr tabindex="0">
                            <td class="border px-4 py-2">
                                <button 
                                    ...
                                    onclick="fetchUserDetails(<?php echo e($user->id); ?>)"
                                    aria-label="Fetch details for <?php echo e($user->name); ?>"
                                >
                            ...
                            <td class="border px-4 py-2">
                                <form action="<?php echo e(route('admin.delete.user', $user->id)); ?>" method="POST" onsubmit="return confirm('Are you sure?');">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button 
                                        class="text-red-500 hover:underline focus:outline-none focus:ring focus:ring-red-300"
                                        aria-label="Delete user <?php echo e($user->name); ?>"
                                    >
                                        Delete
                                    </button>
                                </form>
            ...
            <nav class="mt-4" aria-label="Users pagination">
                <?php echo e($users->appends(request()->except('surf_page'))->links()); ?>
